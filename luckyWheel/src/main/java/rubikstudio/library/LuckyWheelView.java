...
import rubikstudio.library.databinding.LuckyWheelLayoutBinding;
...
//    private ImageView ivCursorView;
    ...
    private void init(Context ctx, AttributeSet attrs) {
        ...
        binding = LuckyWheelLayoutBinding.inflate(inflater);

        binding.pieView.setPieRotateListener(this);
        binding.pieView.setPieBackgroundColor(mBackgroundColor);
        binding.pieView.setPieCenterImage(mCenterImage);
        binding.pieView.setPieTextColor(mTextColor);

        binding.cursorView.setImageDrawable(mCursorImage);

        addView(binding.getRoot());
    }

    public void setLuckyWheelBackgrouldColor(int color) {
        binding.pieView.setPieBackgroundColor(color);
    }

    public void setLuckyWheelCursorImage(int drawable) {
        binding.cursorView.setBackgroundResource(drawable);
    }

    public void setLuckyWheelCenterImage(Drawable drawable) {
        binding.pieView.setPieCenterImage(drawable);
    }

    public void setLuckyWheelTextColor(int color) {
        binding.pieView.setPieTextColor(color);
    }
    ...
    public void setRound(int numberOfRound) {
        binding.pieView.setRound(numberOfRound);
    }

    public void startLuckyWheelWithTargetIndex(int index) {
        binding.pieView.rotateTo(index);
    }
}
